    ...
    >
      ...
      <Card bordered={false} style={{ marginBottom: "32px" }}>
        <Paragraph style={{ fontSize: "16px", marginBottom: "24px" }}>
          My Story: I'm a passionate developer with over 5 years of experience
          ...
          a deep love for crafting user experiences.
        </Paragraph>
        <Paragraph style={{ fontSize: "16px" }}>
          I specialize in modern web technologies and enjoy working on projects
          that challenge me to learn and grow. When I'm not coding, you can find
